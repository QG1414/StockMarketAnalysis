            ...
            children=[
                ...
                dbc.Row(
                    [
                        dcc.Dropdown(
                            [
                                {
                                    "label": f"{row.Symbol} - {row.FullName}",
                                    "value": f"{row.Symbol} - {row.FullName}",
                                }
                ...
                dbc.Row(
                    [
                        dbc.Button(
                            "Change graph",
                            id="change_graph_button",
                            color=self.colors["bg"],
                            className="m-4 me-1 border border-white rounded ",
                            style={
                                "color": self.colors["text"],
                                "width": "120px",
                                "font-size": "13px",
                ...
                dbc.Row(
                    [
                        html.Hr(
                            style={"color": self.colors["text"], "margin-top": "20px"}
                        )
                    ]
                ),
                dbc.Row(
                    ...
                    [
                        dbc.Col(
                            dcc.Dropdown(
                                ...
                                className="pt-1 w-50 mx-auto",
                                placeholder="Select Frist Company",
                                style={
                                    "background-color": self.colors["bg"],
                                    "color": self.colors["text2"],
                                },
                ...
                dbc.Row(
                    dbc.Col(
                        html.P(
                            "\u00a9 All rights reserved. Made by Kacper Potaczała and Łukasz Cal.",
